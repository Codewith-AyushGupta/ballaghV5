            ...
            let response = await axios.post(
                tenantConfiguration.REACT_APP_PIPELINE_PROD_URL,
                {
                    ...
                    pipelineParams: [
                        ...
                        { name: 'pageUrl', value: window.location.origin+'/upload-store-file' },
                        { name: 'fileSuffix', value: 'storeDatabase' },
                    ],
                },
                {
                    headers: {
...
export default GetMagicLinkForStore
